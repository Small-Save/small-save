...
import { arrowBackOutline, checkmarkCircle, informationCircle, lockClosed, personCircle } from "ionicons/icons";
import { useHistory, useParams } from "react-router";
import { confirmGiverPayment, getPaymentDetails } from "services/payments";
                    ...
                    <div className="shield-wrapper">
                        <div className="shield-bg">
                            ...
                            >
                                ...
                                <path
                                    d="M12 15.5L10.5 14C8 11.8 6.5 10.4 6.5 8.7C6.5 7.1 7.8 5.8 9.5 5.8C10.5 5.8 11.4 6.3 12 7C12.6 6.3 13.5 5.8 14.5 5.8C16.2 5.8 17.5 7.1 17.5 8.7C17.5 10.4 16 11.8 13.5 14L12 15.5Z"
                                    fill="#1c5cf1"
                                />
                            </svg>
                        </div>
                    ...
                    <div className="custom-card">
                        <div className="info-box">
                            ...
                            <p className="info-text">
                                Please confirm that you paid the receiver after payment is done by your preferred
                                payment method.
                            </p>
                        </div>
                    ...
                    <div className="actions-container">
                        ...
                        >
                            {isConfirming ? (
                                ...
                                <>
                                    <IonIcon icon={checkmarkCircle} /> Confirm Payment
                                </>
                            )}
                        </button>
