...
import type { BaseResponse, GroupPaymentHistoryResponse, PaymentDetail, paymentStatus } from "types";

export const fetchCurrentPaymentStatus = async (
    groupId: number,
    round_id: number
): Promise<BaseResponse<paymentStatus>> => {
    try {
...
export const confirmReceiverPayment = async (
